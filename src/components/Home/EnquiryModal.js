    ...
    <div className="hidden md:flex absolute right-16 w-full h-full z-20 items-center ">
      <div className="bg-zinc-100/80 px-6 pt-6 pb-8 rounded-lg shadow-lg w-full space-y-0">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full button-3 bg-secondary hover:bg-primary flex justify-center text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
