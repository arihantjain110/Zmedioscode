  ...
  const filterData = [
    {
      ...
      companyName: "Nishba",
      companyDesc:
        "At Nishba, we aim to create a modern Indian lifestyle among women. Our collections are influenced by modesty which allows women to feel fashionably feminine and unique in their own way.",
    },
    {
      heading: "The standard Lorem Ipsum passage, used since the 1500s",
      desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
