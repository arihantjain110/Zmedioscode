    ...
    <div className="container-ack">
      <div className="md:grid grid-cols-3 gap-8 md:space-y-0 space-y-4 md:px-0 px-5">
        <div className="shadow-lg  rounded-lg">
           <img alt="" src="/assets/images/memories/gallery1.png" />
        </div>
        ...
        <div className="shadow-lg rounded-lg">
          <img src="/assets/images/memories/gallery3.png" alt="" />
        </div>
        <div className="shadow-lg rounded-lg">
          <img src="/assets/images/memories/gallery3.png" alt="" />
        </div>
        <div className="shadow-lg rounded-lg">
          <img src="/assets/images/memories/gallery1.png" alt="" />
        </div>
        <div className="shadow-lg rounded-lg col-span-2">
          <img src="/assets/images/memories/gallery4.png" alt="" />
        </div>

        <div className="shadow-lg rounded-lg">
          <img src="/assets/images/memories/gallery5.png" alt="" />
        </div>
        <div className="shadow-lg rounded-lg row-span-2">
          <img src="/assets/images/memories/gallery6.png" alt="" className="h-full" />
        </div>
